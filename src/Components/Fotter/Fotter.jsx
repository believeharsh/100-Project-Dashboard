...
const Fotter = () => {
  return (
    <>
<footer className="footer flex items-center justify-between py-8 bg-neutral text-neutral-content bg-slate-900 text-white px-5 ">
  <aside className="items-center grid-flow-col">
    ...
    <p>Copyright © 2024 - All right reserved <span>❤️- Harsh Dahiya</span></p>
  </aside> 
  <nav className="flex gap-2 px-5">
  <div className="flex flex-col gap-2"></div>
    <a href="https://www.instagram.com/bontinue_/" className="text-3xl font-light">
    <IoLogoInstagram/>
    </a>
    <a href="https://www.instagram.com/bontinue_/" className="text-3xl font-light">
    <FaGithub/>
